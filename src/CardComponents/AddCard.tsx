  ...
  return (
    <>
      <>
        <div
          ref={ref}
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-slate-200 rounded w-[70%] min-h-[200px] shadow-black shadow-2xl z-40 p-5 flex flex-col justify-between"
        >
          <AiFillCloseCircle
            className="absolute right-2 top-2 text-gray-500 w-8 h-8 bg-white rounded-full hover:scale-[1.1] hover:text-black duration-300 z-50"
            onClick={() => {
